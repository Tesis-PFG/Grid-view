...
def registro(PATH_TC, PATH_RM):
# PATH_TC = './INVESTIGACION/Karol Alzate/Alzate_Reuto_Karol_Lorena/Tac_De_Craneo_Simple - 879111/_Head_10_3'

# PATH_RM = './INVESTIGACION/Karol Alzate/IRM Alzate_Reuto_Karol_Lorena/Resonancia_Nuclear_Magnetica_De_Cerebro - RPID001/T1_3D_TFE_AXI_501'
# Leer las imágenes DICOM de CT y MR usando VTK
    ...
    sitk.WriteImage(ct_skull, output_path)
    ...
    output_path = './Data/nifti/patient/fused.nii'
    sitk.WriteImage(blended_image, output_path)
    ...
    image = sitk.ReadImage(output_path)

    # Escribir el archivo MetaImage (.mhd)
    mhd_file = './Data/raw/patient.mhd'
    sitk.WriteImage(image, mhd_file)

    # Escribir el archivo Raw (.raw)
    raw_file = './Data/raw/patient.raw'
    with open(raw_file, 'wb') as f:
        # Convertir la matriz de imagen a bytes
